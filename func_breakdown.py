...
("F08-03", [
 ...
 ("SSO登录链路", "登录页、令牌交换、会话管理", 0, 2, .5, .75, .25),
...
("N3", "【非功能】全局非功能实现与优化", [
 ...
 ("可观测性（日志/监控/告警）", "应用日志规范、作业监控、异常告警通道", 0, .5, 1.5, .25, 0),
 ("容量与增长验证", "600~800表规模扩容压测与容量报告", 0, 0, 1, .5, .25),
]),
("N4", "【非功能】部署与运维支撑", [
 ("Helm发布包与values", "生产values/镜像标签策略/发布Runbook", 0, 1, .25, 0, .25),
...
note = ("对照说明（三个口径）：① 功能直估 %s 人天（BA %s / Wade %s / DevB %s / 测试 %s / SLC %s）——本版已按配置界面/动态表单复杂度上调前端工作量；"
        ...
        "③ 合计 %s 人天 vs 排期计划185人天：Wade %s≈计划60 ✓；DevB %s超计划60约 %s 人天，数据/ETL侧为最大风险口，需靠AI生成ETL与SQL提效吸收；"
        "总缺口约 %s 人天（%.0f%%），建议以本表为规模基线纳入风险跟踪，必要时启用备用赶工日（9/20、10/10）。"
