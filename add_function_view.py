...
WT = {
 "F01-01": ("迁移范围/映射规则澄清与验收标准", "迁移任务管理界面（调度/进度）", "SeaTunnel分片/限速/断点批量导入", "导入用例+样本表验证", "SLC文档F01章"),
 "F01-02": ("文件来源与离线介质场景澄清", "迁移任务界面（文件批次）", "多源文件/大文件/属性保留/包解析", "导入与中断恢复用例", "SLC文档F01章"),
 "F01-03": ("源→标准字段映射规则定义", "规则配置界面", "规则配置服务（映射/转换/校验）", "规则执行用例", "SLC文档F01章"),
 "F01-04": ("完整性基准口径定义", "校验结果展示", "迁移前基准记录（行数/校验和）", "基准记录用例", "SLC文档F01章"),
 "F01-05": ("比对差异处理口径", "比对结果展示", "迁移后比对（SHA-256/差异报告）", "比对用例（CC对账预演）", "SLC文档F01章"),
 "F02-01": ("元数据字段体系与必填规则", "—", "统一元数据模型API", "模块2走查", "SLC文档F02章"),
 "F02-02": ("来源系统编码与绑定规则", "元数据管理界面（协作）", "来源系统信息绑定API", "模块2走查", "SLC文档F02章"),
 "F03-01": ("保留期矩阵与到期处置策略", "保留策略配置界面", "处置引擎（扫描→DROP PARTITION→VACUUM）", "到期删除走查", "SLC文档F03章"),
 "F03-02": ("Legal Hold审批流程定义", "Legal Hold冻结/解除界面", "Hold/Release+豁免+留痕", "冻结/解除走查", "SLC文档F03章"),
 "F04-01": ("密级与加密合规要求", "—", "SSE+CMK+PII字段加密", "加密落盘验证", "SLC文档F04章"),
 "F04-02": ("密钥保管与审计要求", "—", "Key Vault创建/更新/权限/审计", "密钥轮换用例", "SLC文档F04章"),
 "F04-03": ("备份策略要求（RPO）", "—", "备份策略配置+副本创建", "备份恢复用例", "SLC文档F04章"),
 "F04-04": ("灾备要求（RTO）", "—", "异地副本+恢复流程演练", "灾备切换用例", "SLC文档F04章"),
 "F05-01": ("检索需求与查询配置模型", "检索页动态表单+关键词检索", "—", "检索用例", "SLC文档F05章"),
 "F05-02": ("来源系统筛选需求", "按系统名称检索", "—", "筛选用例", "SLC文档F05章"),
 "F05-03": ("时间维度检索需求", "按业务时间检索", "—", "时间范围用例", "SLC文档F05章"),
 "F05-04": ("列表字段/排序/导出需求", "结果列表（分页/排序）+流式导出", "—", "大批量用例", "SLC文档F05章"),
 "F05-05": ("预览格式与权限要求", "在线预览（SAS直连）+大文件优化", "—", "预览用例", "SLC文档F05章"),
 "F06-01": ("审计合规要求（归档日志）", "归档操作日志+审计查询界面", "—", "审计走查", "SLC文档F06章"),
 "F06-02": ("查询行为审计要求", "查询操作日志记录", "—", "审计走查", "SLC文档F06章"),
 "F06-03": ("导出审计要求（范围/IP）", "导出操作日志记录", "—", "审计走查", "SLC文档F06章"),
 "F08-01": ("角色权限矩阵（RBAC）定义", "角色权限配置（界面+API）", "—", "越权用例", "SLC文档F08章"),
 "F08-02": ("账号生命周期策略", "用户账号管理（界面+API）", "—", "账号用例", "SLC文档F08章"),
 "F08-03": ("SSO对接需求（Entra ID）", "SSO集成（登录页+后端链路）", "—", "SSO登录用例", "SLC文档F08章"),
 "F08-04": ("身份映射规则", "身份自动识别与关联", "—", "身份关联用例", "SLC文档F08章"),
 "F08-05": ("异常访问控制策略", "超时/锁定/失效控制", "—", "异常登录用例", "SLC文档F08章"),
}
# 开发人天按功能归属任务分摊
