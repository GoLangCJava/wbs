...
WT = {
 ...
 "F04-01": ("密级与加密合规要求", "—", "SSE+CMK+PII字段加密", "加密落盘验证", "SLC文档"),
 "F04-02": ("密钥保管与审计要求", "—", "Key Vault创建/更新/权限/审计", "密钥轮换用例", "SLC文档"),
 "F04-03": ("备份策略要求（RPO）", "—", "备份策略配置+副本创建", "备份恢复用例", "SLC文档"),
 "F04-04": ("灾备要求（RTO）", "—", "异地副本+恢复流程演练", "灾备切换用例", "SLC文档"),
 ...
 "F08-03": ("SSO对接需求（Entra ID）", "SSO集成（登录页+后端链路）", "—", "SSO登录用例", "SLC文档"),
...
PUBLIC = [
 ...
 ("G7", "非功能与质量专项验证", {"Wade": ["5.1.4", "5.4.1", "7.2.2", "7.2.3", "7.2.7"], "DevB": ["5.2.4", "7.2.5", "7.2.6", "7.2.8"]},
